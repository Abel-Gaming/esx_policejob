...
Config.UseTgiannMDT = true -- Download here: https://github.com/TGIANN/tgiann-mdt
Config.UseT1gerGarage = true -- Purchase here: https://t1ger.store/products/t1ger-garage
